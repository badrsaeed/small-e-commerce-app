...
class Products with ChangeNotifier {
  ...
  getData(String authData, List <Product> prodList) {
    authToken = authData;
  ...
  Future<void> fetchData() async {
    final url = "https://product-app-195f8-default-rtdb.firebaseio.com/product.json?auth=$authToken";
    try {
  ...
  Future<void> updateData(String id) async {
    final url = "https://product-app-195f8-default-rtdb.firebaseio.com/product/$id.json?auth=$authToken";
